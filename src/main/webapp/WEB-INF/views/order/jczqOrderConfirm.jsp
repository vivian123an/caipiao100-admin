...
<div class="main fn_clear user">
	<div class="wrap">
        <div class="order_page">
        	<div class="oreder_title"><em>一场制胜确认投注内容	</em></div>
                    ...
                    <td>
                    	<div class="tdback">
                        	<table cellpadding="0" cellspacing="0" border="0" width="800px">
                                ...
                                <tr>
                                	<td>${betDate }（${gameNumber }）</td>
                                    <td>${footBallMatch.homesxName } VS ${footBallMatch.awaysxName }</td>
                                    <td><c:choose><c:when test="${selectNumber == 3 }">胜</c:when><c:when test="${selectNumber == 1 }">平</c:when><c:otherwise>负</c:otherwise></c:choose>(${selectNumber })</td>
                                </tr>
                            </table>
                        </div>
...
<script type="text/javascript">
   function toBuy(){
        ...
        var footballMatchId="${footballMatchId}";
