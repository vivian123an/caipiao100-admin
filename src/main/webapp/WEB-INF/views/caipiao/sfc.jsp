	...
	<div class="wrap fn_clear">
       ...
       <div class="box848">
       	   <div class="rx9">
               ...
               <div class="trx9">
               	   <em><img src="<%=basePath %>static/images/ico_zq.jpg" /><i>胜负彩</i></em>
                   <cite>
               ...
               <div class="inforx9">
                  <h4>投注说明：14场比赛至少各选1种比赛结果，最高奖金 <i>500万元</i> <a href="#">玩法规则</a></h4>
               </div>
       ...
       <div class="box260">
       	   <div class="modelr">
           	  <div class="title"><em>胜负彩开奖结果</em></div>
             <div class="mdbox">
              	   <h4 class="date"><i>第14081期</i>开奖日期：2014-06-23</h4>
               <h3 class="numk">1000331*******</h3>
           ...
           <div class="adr"><a href="#"><img src="<%=basePath %>static/images/ad4.jpg" /></a></div>
       </div>
    </div>
