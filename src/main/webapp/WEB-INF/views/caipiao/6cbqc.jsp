	...
	<div class="wrap fn_clear">
       ...
       <div class="box848">
       	   <div class="rx9">
               ...
               <div class="trx9">
               	   <em><img src="<%=basePath %>static/images/ico_zq.jpg" /><i>6场半全场</i></em>
                   <cite>
               ...
               <div class="inforx9">
                  <h4>投注说明：对6场比赛的半场和全场至少各选1种比赛结果，最高奖金<i>500万元</i> <a href="#">玩法规则</a></h4>
               </div>
       ...
       <div class="box260">
       	   <div class="modelr">
           	  <div class="title"><em>6场半全场开奖结果</em></div>
             <div class="mdbox">
              	   <h4 class="date"><i>第14090期</i>开奖日期：2014-06-21</h4>
               <h3 class="numk">0000133311**</h3>
